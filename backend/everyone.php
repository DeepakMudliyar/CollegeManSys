...
<body >
    ...
    <div class="clg_title_container"> 
        <div class="collegeLogo">
            <img src="images/collegelogo.jpg" alt="Logo" width=80px>
        </div>
        <div class="collegeNameTitle">
            <h1>Deepak and Vijay College Of Arts Commerce and Science</h1>
        </div>
        <div class="naacLogo" >
