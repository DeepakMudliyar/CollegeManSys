               ...
               <!--first button-->
				...
				<!--third button-->
				<div class="btn-group">
  					<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-list"></span>
				...
				<div class="btn-group">
					  ...
					  Courses Offered <span class="caret"></span>
  					</button>
  				<ul class="dropdown-menu" role="menu">
  				  <li><a href="?tag=course_entry">Course Entry</a></li>
  				  <li><a href="?tag=view_course">View Courses</a></li>
  				</ul>
				</div>
				...
				<!--seventh button-->	
			    <div class="btn-group">
  					<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-plus"></span>
  					  Others <span class="caret"></span>
  					</button>
  				<ul class="dropdown-menu" role="menu">
  				  <li><a href="everyone.php?tag=view_enquiries">View Enquiries/Messages</a></li>
  				  <!-- <li><a href="everyone.php?tag=notifications">Manage notifications</a></li> -->
  				</ul>
				</div>
